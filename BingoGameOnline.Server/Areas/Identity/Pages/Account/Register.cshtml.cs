...
namespace BingoGameOnline.Server.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            // Defensive: always ensure Input and ReturnUrl are set before returning partial
            if (isAjax)
            {
                ReturnUrl ??= Url.Content("~/");
                Input ??= new InputModel();
                // Return only the form partial for AJAX/modal
                return new PartialViewResult
                {
                    ViewName = "/Areas/Identity/Pages/Account/_RegisterFormPartial.cshtml",
